...
const TEST_PREFIX = 'postgrest-rq-update-item';
...
describe('useUpdateItem', () => {
  ...
  it('should not update items in different tables', async () => {
    const queryClient = new QueryClient();
    const USERNAME = `${testRunPrefix}-diff-table`;
    ...
    // Original data should be unchanged (different table)
    expect(screen.getByTestId('username').textContent).toBe(USERNAME);
