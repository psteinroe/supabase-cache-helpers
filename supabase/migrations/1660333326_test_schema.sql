...
insert into public.country (code, continent_code, name, iso3, number, full_name)
    values ('AF', 'AS', 'Afghanistan', 'AFG', '004', 'Islamic Republic of Afghanistan'),
...
create table public.contact (
    ...
    continent char(2) references public.continent on delete set null,
    username text,
...
create function has_low_ticket_number (contact)
    returns boolean
    as $$
    select
        $1.ticket_number < 100;
